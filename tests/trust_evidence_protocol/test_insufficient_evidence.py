...
def test_false_analogy_is_red():
    assert_case(
        ...
        Реши только один вопрос: можно ли классифицировать текущий 502 как
        повтор proxy-инцидента?
        green = да, proxy-причина подтверждена; red = нет, текущие факты
        ослабляют proxy-гипотезу; ask = текущий статус proxy неизвестен.
        """,
        expected="red",
        answer_options=("green", "red", "ask"),
    )
